...
#mkdir -p $plotFolder
start1=`date +%s`
echo "############### START TRAIN and TEST SIMULATION Elman RNN & Jordan RNN on window size 7 9 11 5 3 1 hl 100 137 ed 100 60 ##################"
echo " "
...
do
    for bs_temp in 10 7
    do
        for emb_dimension_temp in 60 100
        do
            for win_temp in 1 3 5 7 9 11
            do
                for nhidden_temp in 100 137
                do
