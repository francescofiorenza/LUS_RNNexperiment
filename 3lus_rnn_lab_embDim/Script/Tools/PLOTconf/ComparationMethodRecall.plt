...
set output '../output/PLOT/CONCEPT/ClusterMethodPlotRecall_WORD.png'
set title "WORD as TOKEN recall\n NLSPARQL classification with the different smoothing method"  font "sans, 13" 
...
plot [:8] [:]'../output/PLOT/CONCEPT/recall.dat' using 2:xtic(1) ti col,\
      '' u 3 ti col, \
      '' u 4 ti col, \
      '' u 5 ti col, \
      '' u 6 ti col, \
